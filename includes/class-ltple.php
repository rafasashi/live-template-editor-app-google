...
class LTPLE_App_Google extends LTPLE_Client_App {

	/**
	 * The single instance of LTPLE_App_Google.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main LTPLE_App_Google Instance
	 *
	 * Ensures only one instance of LTPLE_App_Google is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_App_Google()
	 * @return Main LTPLE_App_Google instance
	 */
